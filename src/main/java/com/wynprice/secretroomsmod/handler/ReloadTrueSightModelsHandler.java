...
public class ReloadTrueSightModelsHandler 
{
	...
	{
		if(event.player instanceof EntityPlayerSP && event.player.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() instanceof TrueSightHelmet != lastTickHelmet)
		{
