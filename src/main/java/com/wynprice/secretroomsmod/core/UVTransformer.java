...
public class UVTransformer implements IClassTransformer
{
	...
	public byte[] transform(String name, String transformedName, byte[] basicClass) 
	{
		if(!transformedName.equals("net.minecraft.client.renderer.block.model.FaceBakery"))
            return basicClass;
		String methodStoreVertexName = UVCore.isDebofEnabled ? "func_178404_a" : "storeVertexData";
        ...
        LocalVariableNode faceData = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_1_" : "faceData", "[I", null, startLabel, endLabel, 0);
        LocalVariableNode storeIndex = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_2_" :"storeIndex", "I", null, startLabel, endLabel, 1);
        LocalVariableNode vertexIndex = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_3_" : "vertexIndex", "I", null, startLabel, endLabel, 2);
        LocalVariableNode position = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_4_" : "position", "Lorg/lwjgl/util/vector/Vector3f;", null, startLabel, endLabel, 3);
        LocalVariableNode shadeColor = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_5_" : "shadeColor", "I", null, startLabel, endLabel, 4);
        LocalVariableNode sprite = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_6_" : "sprite", "Lnet/minecraft/client/renderer/texture/TextureAtlasSprite;", null, startLabel, endLabel, 5);
        LocalVariableNode faceUV = new LocalVariableNode(UVCore.isDebofEnabled ? "p_178404_7_" : "faceUV", "Lnet/minecraft/client/renderer/block/model/BlockFaceUV;", null, startLabel, endLabel, 6);
