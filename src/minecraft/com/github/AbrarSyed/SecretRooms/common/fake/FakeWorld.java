package com.github.AbrarSyed.SecretRooms.common.fake;
...
public class FakeWorld extends World implements IBlockAccess
{
	...
	{
		super(handler, "fake", new WorldSettings(world.getWorldInfo()), provider, null);
		this.world = world;
	...
	public TileEntity getBlockTileEntity(int x, int y, int z)
	{
		ChunkPosition pos = new ChunkPosition(x, y, z);
		if (overrideMap.containsKey(pos))
			return overrideMap.get(pos).getTileEntity(world);
		else
	...
	{
		return world.setBlockAndMetadata(par1, par2, par3, par4, par5);
	}
	...
	{
		world.setBlockMetadataWithNotify(par1, par2, par3, par4);
	}

	@Override
	public boolean setBlockMetadata(int par1, int par2, int par3, int par4)
	{
		return world.setBlockMetadata(par1, par2, par3, par4);
	}

	@Override
	public boolean setBlockWithNotify(int par1, int par2, int par3, int par4)
	{
		return world.setBlockWithNotify(par1, par2, par3, par4);
	}

	@Override
	public boolean setBlockAndMetadataWithNotify(int par1, int par2, int par3, int par4, int par5)
	{
		return world.setBlockAndMetadataWithNotify(par1, par2, par3, par4, par5);
	}

	@Override
	public void markBlockForRenderUpdate2(int par1, int par2, int par3)
	{
		world.markBlockForRenderUpdate2(par1, par2, par3);
	}
	...
	{
		return world.getMoonPhase(par1);
	}
	...
	{
		return world.drawClouds(par1);
	}

	@Override
	public void scheduleBlockUpdateFromLoad(int par1, int par2, int par3, int par4, int par5)
	{
		world.scheduleBlockUpdateFromLoad(par1, par2, par3, par4, par5);
	}
	...
	{
		return world.canPlaceEntityOnSide(par1, par2, par3, par4, par5, par6, par7Entity);
	}
	...
	{
		return world.isBlockGettingPowered(par1, par2, par3);
	}

	@Override
	public boolean isBlockIndirectlyProvidingPowerTo(int par1, int par2, int par3, int par4)
	{
		return world.isBlockIndirectlyProvidingPowerTo(par1, par2, par3, par4);
	}
}
