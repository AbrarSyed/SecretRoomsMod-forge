...
public class TileEntityCamoChest extends TileEntityCamoFull implements IInventory 
{
	...
	public void checkForAdjacentChests() {
		if (!this.adjacentChestChecked) {
			...
			if (this.worldObj.getBlockId(this.xCoord - 1, this.yCoord,
					this.zCoord) == SecretRooms.camoChest.blockID) {
				this.adjacentChestXNeg = (TileEntityCamoChest) this.worldObj
			...
			if (this.worldObj.getBlockId(this.xCoord + 1, this.yCoord,
					this.zCoord) == SecretRooms.camoChest.blockID) {
				this.adjacentChestXPos = (TileEntityCamoChest) this.worldObj
						.getBlockTileEntity(this.xCoord + 1, this.yCoord,
								this.zCoord);
			}

			if (this.worldObj.getBlockId(this.xCoord, this.yCoord,
					this.zCoord - 1) == SecretRooms.camoChest.blockID) {
				this.adjacentChestZNeg = (TileEntityCamoChest) this.worldObj
			...
			if (this.worldObj.getBlockId(this.xCoord, this.yCoord,
					this.zCoord + 1) == SecretRooms.camoChest.blockID) {
				this.adjacentChestZPosition = (TileEntityCamoChest) this.worldObj
						.getBlockTileEntity(this.xCoord, this.yCoord,
								this.zCoord + 1);
			}
	...
	public void openChest() {
		...
		this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord,
				SecretRooms.camoChest.blockID, 1, this.numUsingPlayers);
	}
